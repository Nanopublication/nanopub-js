# Contributing to `nanopub-js`

A big welcome and thank you for considering contributing to `nanopub-js`! It's people like you that
...
Contributions are made to this repo via **Issues** and **Pull Requests (PRs)**. A few general guidelines that cover
both:
